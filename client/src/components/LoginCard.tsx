          ...
          <div className="flex justify-center">
            <div className="relative">
              ...
              <img 
                src={bpnLogoUrl} 
                alt="BPN" 
                className="relative h-20 w-auto max-w-[140px] object-contain transition-all duration-300 hover:scale-105 filter drop-shadow-lg dark:invert dark:hue-rotate-180"
              />
            </div>
          </div>
